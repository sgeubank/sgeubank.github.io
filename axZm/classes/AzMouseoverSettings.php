...
if (!class_exists('AzMouseoverSettings', false)) {
    ...
    {
        public $vendor = '';
        public $last_updated = '2022-03-31';
        public $config = array();
        public $items = array();
...
Object with properties and values that overrides any option of this extension for mobile touch devices.',
                        'DE' => '
Objekt mit Eigenschaften und Werten, das alle Optionen dieser Erweiterung für mobile Touch-Geräte überschreibt.',
                    ),
                ),
...
Slide back to the same item/image if the movement does not exceed this percentage of the preview area.',
                        'DE' => '
Zurückkehren zum selben Objekt / Bild,
wenn die Bewegung beim Sliden diesen Prozentsatz des Vorschaubereichs nicht überschreitet.',
                    )
                ),

                'slideBackCond2' => array(
                    'prefix' => 'AJAXZOOM_MOZP',
                    'category' => 'mouseover',
                    'type' => 'int',
                    'isJsObject' => false,
...
Slide to the next item/image if the sliding movement exceeds this amount of pixels.',
                        'DE' => '
Zum nächsten Objekt / Bild sliden,
wenn die Schiebebewegung diese Anzahl von Pixeln überschreitet.',
                    )
                ),
