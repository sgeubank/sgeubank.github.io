...
// Slide back to the same item/image if the movement does not exceed this percentage of the viewer.
$zoom['config']['gallerySlideSwipeBackCond1'] = 0.1; // float

// Slide to the next item/image if the sliding movement exceeds this amount of pixels.
$zoom['config']['gallerySlideSwipeBackCond2'] = 100; // int
